  ...
  <section class="flex flex-col items-center w-full gap-8 px-4 py-24 pb-16">
    <div class="flex flex-col gap-16">
      <div class="flex flex-col items-center justify-center w-full gap-3">
        <span class="font-medium capitalize text-primary">How it works</span>
        <h1 class="w-full text-4xl text-center text-white lg:w-2/3 lg:text-5xl">Top–notch designs,
