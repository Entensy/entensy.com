...
import { revealVariant, slideRevealLeftVariant } from "@/lib/animations";
...
function InfoCard({
  ...
  return (
    <motion.div
      ...
      whileTap={{
        scale: 1.01,
        boxShadow: "0 16px 44px rgba(252,0,42,0.28)",
      ...
      <motion.div
        ...
        style={{
          background: isDark
            ? "radial-gradient(ellipse at 100% 100%, rgba(252,0,42,1) 0%, rgba(252,0,42,0.3) 50%, transparent 75%)"
            : "radial-gradient(ellipse at 100% 100%, rgba(252,0,42,0.18) 0%, rgba(252,0,42,0.06) 50%, transparent 75%)",
        }}
        animate={{ scale: hovered ? 1.5 : 1, opacity: hovered ? 0.6 : 0.3 }}
        whileTap={{ scale: 2.2, opacity: 0.7 }}
      ...
      <div className='min-w-0'>
        ...
        {href ? (
          <a
            ...
            {...(isRtl && href.startsWith("tel:")
              ? { dir: "ltr", style: { unicodeBidi: "bidi-override" } }
              : {})}>
...
export default function ContactSection() {
  ...
  const ctaCardReveal = useScrollReveal(
    ctaCardRef as { current: Element | null },
  );
    ...
    <section
      ...
      <div className='absolute inset-0 z-0 pointer-events-none overflow-hidden'>
        ...
        <div
          ...
          style={{
            background: `radial-gradient(ellipse at 0% 50%, rgba(252,0,42,${isDark ? "0.12" : "0.04"}) 0%, transparent 65%)`,
          }}
        />
        <div
          className='absolute inset-y-0 right-0 w-1/2'
          style={{
            background: `radial-gradient(ellipse at 100% 50%, rgba(201,168,76,${isDark ? "0.08" : "0.03"}) 0%, transparent 65%)`,
          }}
        />
          ...
          <div className='flex flex-col gap-6'>
            ...
            <motion.div
              ...
              <div
                ...
                style={{
                  background: `radial-gradient(ellipse at 80% 80%, rgba(201,168,76,${isDark ? "0.12" : "0.04"}) 0%, transparent 60%)`,
                }}
              />
