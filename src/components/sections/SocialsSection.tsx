...
const socialLinks = [
  {
    ...
    color: "#1877F2",
    iconColor: "#1877F2",
    bgFrom: "rgba(24,119,242,0.10)",
    bgTo: "rgba(24,119,242,0.05)",
    bgHoverFrom: "rgba(24,119,242,0.22)",
  ...
  },
  {
    ...
    bgFrom: "rgba(252,175,69,0.10)",
    bgTo: "rgba(131,58,180,0.05)",
    bgHoverFrom: "rgba(252,175,69,0.22)",
    bgHoverTo: "rgba(131,58,180,0.12)",
  ...
  },
  {
    ...
    color: "#E7E9EA",
    iconColor: "#E7E9EA",
    bgFrom: "rgba(231,233,234,0.10)",
    bgTo: "rgba(100,100,100,0.05)",
    bgHoverFrom: "rgba(231,233,234,0.22)",
    bgHoverTo: "rgba(120,120,120,0.12)",
  ...
  },
  {
    ...
    color: "#EE1D52",
    iconColor: "#010101",
    bgFrom: "rgba(238,29,82,0.10)",
    bgTo: "rgba(105,201,208,0.05)",
    bgHoverFrom: "rgba(238,29,82,0.22)",
  ...
  },
  {
    ...
    color: "#FF0000",
    iconColor: "#FF0000",
    bgFrom: "rgba(255,0,0,0.10)",
    bgTo: "rgba(200,0,0,0.05)",
    bgHoverFrom: "rgba(255,0,0,0.22)",
    bgHoverTo: "rgba(200,0,0,0.12)",
  ...
  },
  {
    ...
    color: "#0A66C2",
    iconColor: "#0A66C2",
    bgFrom: "rgba(10,102,194,0.10)",
    bgTo: "rgba(10,102,194,0.05)",
    bgHoverFrom: "rgba(10,102,194,0.22)",
              ...
              style={
                {
                  ...
                  background: `radial-gradient(circle, ${obj.color} 0%, ${obj.color.replace(/[\d.]+\)$/, "0.025)")} 50%, transparent 80%)`,
                  "--dur": obj.dur,
                  "--delay": obj.delay,
                } as React.CSSProperties
              }
